...
function setup(){
    ...
    for(var i = 0; i <= 100; i++){
       drops.push(new Drops(random(0,800), random(0,800)));//Y AQUI LAS POSICIONES EN X Y "Y" DEBEN SER RANDOM 
    }                                                      //DE 0 AL VALOR QUE QUIERAS, YO LE PUSE 800 
}
...
function draw(){
    ...
    for(var i = 0; i < 100; i++){
       drops[i].display();
       //NOS FALTABA AGREGAR ESTA FUNCION DE LA CLASE DROPS
       drops[i].update();
    }
